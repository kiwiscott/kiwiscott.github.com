...
excerpt: A day in the life of a daeveloper
---
      
{% highlight csharp %}
namespace JPMC.ISS.Framework.Reference
{
    public enum ReferenceItemTypes
    {
        CHANGE_CANCEL_REASON,
        CHANGE_DEFERRAL_REASON,
        APPROVAL_DECLINE_REASON,
        APPROVAL_IMPACT_REASON,
        CHANGE_ATTACHMENT_TYPES,
        IMPACTED_CI_TYPES,
        ...
        EXPEDITED_REASON,
        SOURCE,
        TASK_DEFERRED_REASON,
        TASK_CANCELLED_REASON,
        TASK_COMMENT_TYPE,
        TARGETED_CI_TYPES,
        LOCATION_COUNTRY, 
